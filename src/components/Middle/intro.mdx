...
Previously I wored as a Cloud Architect for [Amazon Web Services](https://aws.amazon.com), where I built solutions for customers in the public sector, our clients included universities, government departments, and non-for-profits.
...
Right now I'm a committee member of the [Young Engineers Australia](https://yea.engineersaustralia.org.au/) in the Victorian Division. We run events to connect and engage young engineers who are beginning their careers in Australia.
