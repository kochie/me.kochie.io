...
export const AppleStartupImages: AppleImage[] = [
  ...
  {
    url: '/assets/apple-splash-dark-1290-2796.jpg',
    media:
  ...
  {
    url: '/assets/apple-splash-dark-2796-1290.jpg',
    media:
  ...
  {
    url: '/assets/apple-splash-dark-1179-2556.jpg',
    media:
  ...
  {
    url: '/assets/apple-splash-dark-2556-1179.jpg',
    media:
